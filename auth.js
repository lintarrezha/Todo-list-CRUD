// function showWarning(inputId, show) {
//   const warningId = inputId + '-warning';
//   document.getElementById(warningId).style.display = show ? 'block' : 'none';
// }

// function validateInput(input) {
//   const length = input.value.length;
//   showWarning(input.id, length < 4 || length > 20);
// }
...
//     usernameInput.addEventListener('input', function() {validateInput(this);});
//     passwordInput.addEventListener('input', function() {validateInput(this);});
//   }
